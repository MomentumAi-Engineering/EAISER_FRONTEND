                        ...
                        <div className="bg-[#0a1628] border border-gray-800 rounded-xl p-6">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8">
                                        ...
                                        <div className="flex-1 space-y-4">
                                            ...
                                            <div className="flex items-center gap-2 bg-gray-900 p-3 rounded-lg border border-gray-700 font-mono text-lg tracking-wider">
                                                {secretData.secret}
                                                <button onClick={copySecret} className="ml-auto p-2 hover:text-blue-400 transition-colors">
                                            ...
                                            <div className="flex gap-2">
                                                <input
                                                    ...
                                                    placeholder="000000"
                                                    className="w-32 px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-white text-center tracking-widest text-xl focus:border-blue-500 focus:outline-none transition-all"
                                                />
                                                <button
                            ...
                            {is2FAEnabled && (
                                <div className="bg-black/40 rounded-lg p-6 border border-gray-800 flex justify-between items-center">
                                    ...
                                    <button
                                        onClick={disable2FA}
                                        className="px-4 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 rounded-lg border border-red-500/30 transition-all"
                                    >
                                        Disable 2FA
                                    </button>
                                </div>
