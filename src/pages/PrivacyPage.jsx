                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                            ...
                            <p className="text-zinc-500 max-w-sm text-sm font-medium leading-relaxed">
                                Our commitment to protecting your digital footprint. Reviewed and updated regularly to ensure maximum security.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <div className="grid lg:grid-cols-[280px_1fr] gap-16 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32 space-y-8">
                            <div>
                                <h4 className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-6 px-4">Navigation</h4>
                            ...
                            <div className="p-6 bg-zinc-900/50 border border-white/5 rounded-3xl space-y-4">
                                <h5 className="text-[10px] font-black text-white uppercase tracking-widest">Need help?</h5>
                                <p className="text-xs text-zinc-500 leading-relaxed">
                                    Questions about your data? Reach out to our dpo.
                                </p>
