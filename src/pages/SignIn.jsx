      ...
      <div className="w-full max-w-md">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-white text-black font-semibold py-3 rounded-full hover:bg-gray-100 transition-colors flex items-center justify-center gap-3"
          >
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="flex-1 bg-gray-900 text-white font-medium py-3 rounded-full hover:bg-gray-800 transition-colors flex items-center justify-center border border-gray-800"
            >
